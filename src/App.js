...
class App extends Component {
  ...
  render() {
    ...
    if (this.state.logged === '1') {
      ...
      return (
        <Fblogin loginStatus={this.loginStatus} logged={this.state.logged} />
      )
    }
    else if (this.state.logged === '3') {
      return (
        <div>
          <Mapapp icon2={<img className="d-inline-block align-top" src="./apseando_ando.jpg" width="30" height="30" alt='none'></img>} logout={this.loginOut}></Mapapp>
        </div>
      )
        ...
        <div className='ml-auto mr-auto border rounded mt-1'>
          <nav className="navbar navbar-light bg-light">
            <a href="/" className="text-danger">
              <img className="d-inline-block align-top" src="./apseando_ando.jpg" width="40" height="40" alt='none'></img>
          ...
          <form className="container col-12 col-sm-7 col-md-5 col-lg-4">
            ...
            <div className="row social-login">
              <Fblogin logged={this.state.logged} loginStatus={this.loginStatus}>
              </Fblogin>
